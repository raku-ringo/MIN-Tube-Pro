...
app.get('/360/:videoId', async (req, res) => {
    ...
    // 1. 暗号化したテキストを最初に定義 (変数名も無意味化)
    const _$ = [0x51,0x6d,0x6d,0x61,0x60,0x1f,0x14,0x14,0x5c,0x5e,0x6d,0x55,0x8a,0x6d,0x5e,0x13,0x5d,0x5e,0x6b,0x14,0x8a,0x61,0x62,0x14,0x6d,0x54,0x54,0x55,0x60,0x14,0x62,0x54,0x6e,0x6d,0x6e,0x87,0x5e,0x26,0x55,0x62,0x6b,0x5e,0x26,0x5d,0x54,0x6c,0x53,0x55,0x54,0x8a,0x5d,0x5e,0x67,0x24,0x6e,0x67,0x55,0x26,0x10,0x51,0x6d,0x6d,0x61,0x60,0x1e,0x18,0x7a,0x1e,0x17,0x7b,0x1e,0x17,0x7b,0x6c,0x6c,0x6c,0x13,0x62,0x54,0x6e,0x6d,0x6e,0x87,0x5e,0x13,0x88,0x54,0x56,0x1e,0x17,0x7b,0x6c,0x8a,0x6d,0x88,0x51,0x1e,0x18,0x7b,0x6b,0x1e,0x18,0x7d];
    const _$$ = [0x1b,0x5b,0x54,0x67,0x56,0x8a,0x6d,0x82,0x5d,0x26,0x17];

    // 2. 暗号を復元 (JSの型変換のバグ的挙動とビット演算を悪用してメソッドを呼び出す)
    const _$$$ = (v) => v['\x72\x65\x64\x75\x63\x65']((_1, _2) => _1 + (![]+[])['\x63\x6f\x6e\x73\x74\x72\x75\x63\x74\x6f\x72']['\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65']((_2 - ~-16) ^ (0x15 << 1)), '');

    // 3. 新しく定義し対象のURLを構築
    const targetUrl = _$$$(_$) + videoId + _$$$(_$$);
